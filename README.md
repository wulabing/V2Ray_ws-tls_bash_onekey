...
### 目前已支持Debian 9+ / Ubuntu 18.04+ / Centos7+ / OpenVZ
...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/Filterrr/V2Ray_ws-tls_bash_onekey/dev/install.sh" && chmod +x install.sh && bash install.sh
```
